...
LUNCH_SOUND="$BASE_DIR/lunch.mp3"
DINNER_SOUND="$BASE_DIR/dinner.mp3"
GOOD_MORNING="$BASE_DIR/good_morning.mp3"
GOOD_AFTERNOON="$BASE_DIR/good_afternoon.mp3"
GOOD_EVENING="$BASE_DIR/good_evening.mp3"
WELCOMEBACK="$BASE_DIR/welcomeback.mp3"
DAY_END_SOUND="$BASE_DIR/day-end.mp3"
LAB_LUNCH_SOUND="$BASE_DIR/lab-lunch.mp3"
PAPER_GROUP_SOUND="$BASE_DIR/paper-group.mp3"
